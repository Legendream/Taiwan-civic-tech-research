...
PALETTE = {
    ...
    # 困擾量表 1–5 分堆疊圖專用：1、2 分用淺灰（沒卡住），3–5 分用逐漸加深的暖色（卡住的程度）。
    # 05_figures.py 與 13_web_data.py 都畫這張圖（PNG／網頁互動版），色階只在這裡定義一次。
    "trouble_scale": ["#e8e8e4", "#cfcfc9", "#f4c6ad", "#e8895b", "#b5342a"],
}
